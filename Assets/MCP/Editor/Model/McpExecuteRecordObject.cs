...
namespace UniMcp.Models
{
    ...
    public class McpExecuteRecordObject : ScriptableSingleton<McpExecuteRecordObject>
    {
        ...
        public void InitializeDefaultGroup()
        {
            ...
            {
                CreateGroup("default", "Default Group", "Default system group for uncategorized records", true);
            }
            ...
            // Rename old Chinese group name to English
            var defaultGroup = GetGroup("default");
            if (defaultGroup != null && defaultGroup.name.Contains("默认"))
            {
                defaultGroup.name = "Default Group";
                defaultGroup.description = "Default system group for uncategorized records";
            }

            // Reset to default if current group is invalid
        ...
        public string GetGroupStatistics(string groupId)
        {
            ...
            return $"{group.records.Count} records (OK:{successCount} Fail:{errorCount})";
        }
