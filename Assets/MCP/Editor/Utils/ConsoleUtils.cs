    ...
    public static class ConsoleUtils
    {
        ...
        static ConsoleUtils()
        {
            try
            {
                ...
                // instanceID field is optional - may not exist in Unity 6+
                _instanceIdField = logEntryType.GetField("instanceID", instanceFlags);
                // Don't throw if not found - it's optional in newer Unity versions
            }
            catch (Exception e)
            {
                McpLogger.LogError(
        ...
        {
            // instanceIdField is optional in Unity 6+
